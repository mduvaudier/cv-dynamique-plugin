...
import type { CompanyType } from "../assets/data/timeline";
...
export default function Timecard(props: TimecardProps): React.JSX.Element {
  const companies: CompanyType[] = props.company;
  const keywords: string[] = props.keywords
  const { t } = useTranslation();

  const companiesList: React.JSX.Element[] = Array.isArray(companies)
  ...
  const keywordsList: React.JSX.Element[]  = Array.isArray(keywords)
